...
import com.uber.ugsb.model.distro.ConstantDegreeDistribution;
import com.uber.ugsb.model.distro.LogNormalDegreeDistribution;
import com.uber.ugsb.schema.InvalidSchemaException;
import com.uber.ugsb.schema.QualifiedName;
import com.uber.ugsb.schema.SchemaBuilder;
...
public class GraphModelTest {
    ...
    private static Vocabulary createVocabulary() throws InvalidSchemaException, IOException {
        ...
        try (InputStream in = UgraphVocabulary.CoreSchema.CORE.getYamlInputStream()) {
